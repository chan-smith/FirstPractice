...
{
    public class CategoriesAutoController : Controller
    {
        ...
        // GET: CategoriesAuto/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: CategoriesAuto/Create
